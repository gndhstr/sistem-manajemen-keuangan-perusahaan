...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="overflow: hidden">
    <!-- Brand Logo -->
    <a href="/direktur/dashboard" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="/manajer/dashboard" class="nav-link">
                        <i class="nav-icon fa fa-dashboard"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/manajer/anggaran" class="nav-link">
                        <i class="nav-icon fa fa-money"></i>
                        <p>Kelola Anggaran</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/manajer/mutasi" class="nav-link">
                        <i class="nav-icon fa fa-dollar"></i>
                        <p>Mutasi Karyawan</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/manajer/karyawan" class="nav-link">
                        <i class="nav-icon fa fa-group"></i>
                        <p>Kelola Karyawan</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/manajer/kategori" class="nav-link">
